          ...
          <div class="row content-panel">
            <div class="col-lg-10 col-lg-offset-1">
              <div class="invoice-body">
                ...
                <button class="btn  btn-sm tooltips" data-original-title="good" type="button" onclick="location.href='/fastfood/main/bburgergood.do?idx=${item.idx}'" data-toggle="tooltip" data-placement="top" title=""><i class="fa fa-thumbs-o-up"></i> ${item.good} </button>
